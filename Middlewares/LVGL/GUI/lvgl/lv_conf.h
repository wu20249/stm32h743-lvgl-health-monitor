...
#define LV_MEM_CUSTOM 1
    ...
    #define LV_MEM_CUSTOM_ALLOC(size)   mymalloc(SRAMEX, (size))
    #define LV_MEM_CUSTOM_FREE(ptr)    myfree(SRAMEX, (ptr))
    #define LV_MEM_CUSTOM_REALLOC(ptr, size) myrealloc(SRAMEX, (ptr), (size))
#endif     /*LV_MEM_CUSTOM*/
